#!/usr/bin/env python3
"""
Upload gift basket products and images to Odoo
"""
import csv
import base64
import sys
...
print(f"Found {len(products)} gift basket products in CSV\n")
print("=" * 70)
print("UPLOADING GIFT BASKETS TO ODOO")
print("=" * 70)
...
print("\n" + "=" * 70)
print("GIFT BASKETS UPLOAD COMPLETE")
print("=" * 70)
