#!/usr/bin/env python3
"""
Upload sports card products and images to Odoo
"""
import csv
import base64
import sys
...
print(f"Found {len(products)} sports card products in CSV\n")
print("=" * 70)
print("UPLOADING SPORTS CARDS TO ODOO")
print("=" * 70)
...
print("\n" + "=" * 70)
print("SPORTS CARDS UPLOAD COMPLETE")
print("=" * 70)
