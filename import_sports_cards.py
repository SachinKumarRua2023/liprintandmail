#!/usr/bin/env python3
"""
Import sports card products into Odoo from CSV
"""
import csv
import sys
import time
...
# Read CSV
csv_path = "products_sports_cards.csv"
products = []
...
print(f"Found {len(products)} sports card products to import\n")
print("=" * 70)
print("IMPORTING SPORTS CARDS TO ODOO")
print("=" * 70)
...
print("\n" + "=" * 70)
print("SPORTS CARDS IMPORT COMPLETE")
print("=" * 70)
print(f"Success: {success_count}")
print(f"Failed:  {failed_count}")
print(f"Total:   {len(products)}")
print("=" * 70)
print("\nNext step: Run upload_sports_cards.py to attach images")
